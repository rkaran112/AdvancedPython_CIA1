...
Run this from the repo root so it can find `state_wise_silver_purchased_kg.csv`. To see the choropleth map in the "State-wise Sales" tab, upload `india_state_geo.json` (included in this repo) via the file uploader in that tab.
